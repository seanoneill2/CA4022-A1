...
-- 1. First I cleaned my drinks data
...
-- 3. Extended drinks file cleaning
...
-- I have now cleaned all 3 of my datasets and have them stored in starbucks-clean-data folder
