...
-- First pig query to find most calories from drinks file
...
-- Next query to find what drink has moist variations from extended drinks file
...
-- Lastly, find drinks with fewest variations
